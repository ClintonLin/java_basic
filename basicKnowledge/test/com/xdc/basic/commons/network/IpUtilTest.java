...
public class IpUtilTest
{
    ...
    {
        Assert.assertEquals(true, IpUtil.isInSameSubnet("128.128.5.2", "128.128.5.3", "255.255.255.0"));

        Assert.assertEquals(false, IpUtil.isInSameSubnet("128.128.5.2", "128.128.6.2", "255.255.255.0"));
    }
}
