...
public class FindErrorCode
{
            ...
            throws IllegalArgumentException, IllegalAccessException, InstantiationException, ClassNotFoundException
    {
        ...
        classArrayList.add("com.xdc.errorcode.ICSErrorCode");
        ...
        classArrayList.add("com.xdc.errorcode.LinkedVMGroupErrorCode");
        classArrayList.add("com.xdc.errorcode.OmErrorCode");
        classArrayList.add("com.xdc.errorcode.SGErrorCode");
